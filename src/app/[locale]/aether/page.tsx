...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/${locale}/aether`,
      languages: { en: "/en/aether", ar: "/ar/aether" },
    },
  };
}
    ...
    <div className="container-brand section-y">
      <Reveal>
        <header className="mb-12 max-w-2xl">
          ...
          <h1 className="font-display text-4xl md:text-5xl lowercase">{messages.home.collectionsAether.name}</h1>
